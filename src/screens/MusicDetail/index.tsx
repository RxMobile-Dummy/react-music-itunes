        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <ImageBackground
                    ...
                    resizeMode={'stretch'}
                    source={{
                        uri: podcast ? musicDetail.artworkUrl600 : musicDetail.artworkUrl100
                    }}
                >
                    ...
                    <View style={styles.txtVw}>
                        <View style={styles.rgbVw}>
                            <Text style={styles.collectionTxt}>{podcast ? String.Podcast : String.Artist}</Text>
                            <Text style={styles.artstTxt}>{podcast ? musicDetail.collectionName : musicDetail.artistName}</Text>
                        </View>
                    </View>
                </ImageBackground>
                <View style={styles.mainBottomVw}>
                    ...
                    <View style={styles.mainTabVw}>
                        ...
                        <View style={styles.tabVw}>
                            <Text style={styles.tabDetailTxt}>{podcast ? String.EpiPrice : String.FollowingTxt}</Text>
                            <Text style={styles.tabTitleTxt}>${musicDetail.trackPrice ? musicDetail.trackPrice : "0"}</Text>
                        </View>
                    </View>
                    <Text style={styles.albumTxt}>{podcast ? String.Episode : String.Albums}</Text>
                    <View style={styles.mainCardView}>
                        <Image source={{
                            uri: podcast ? musicDetail.artworkUrl600 : musicDetail.artworkUrl100
                        }} style={styles.artImg} resizeMode={"cover"} />
                        <View style={styles.cardTxtVw}>
                            <Text style={styles.cardTitleTxt}>{podcast ? musicDetail.trackName : musicDetail.collectionName}</Text>
